  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="md:hidden flex flex-col min-h-screen bg-black relative">
        ...
        <button
          onClick={scrollToContent}
          className="absolute top-1/2 left-[50vw] -translate-x-1/2 -translate-y-1/2 text-white flex flex-col items-center gap-0.5 animate-bounce cursor-pointer hover:opacity-70 transition-opacity z-10"
          aria-label="Scroll vers le contenu"
        >
