                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-4">
                    ...
                    >
                      ...
                      <div className="mt-3">
                        ...
                        <h2 className="text-lg md:text-xl font-bold">{reco.film.title}</h2>
                    ...
                    >
                      ...
                      <div className="mt-3">
                        ...
                        <h2 className="text-lg md:text-xl font-bold">{reco.album.title}</h2>
                        <p className="text-sm text-muted-foreground">
                    ...
                    {/* Club - fond noir, titre sur l'image */}
                    <a
                      href={reco.club.link}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    {/* Expo - fond noir, titre sur l'image */}
                    <a
                      href={reco.expo.link}
                      target="_blank"
                      rel="noopener noreferrer"
